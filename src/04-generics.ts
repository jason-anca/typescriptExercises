...
function sortedCopy<T>(data: T[], criteria: (d: T, d2: T) => number): T[] | undefined {
    return data.sort(criteria)
}


// Sort friends by age
console.log(sortedCopy<Friend>(friends, (a, b) => a.age - b.age));
// Sort colleagues by extension number
console.log(sortedCopy<Colleague>(colleagues.current, (a, b) => a.contact.extension - b.contact.extension));
